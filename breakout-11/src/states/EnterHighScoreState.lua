...
function EnterHighScoreState:update(dt)
	if love.keyboard.wasPressed('enter') or love.keyboard.wasPressed('return') then
		...
		-- go backwards through high scores table until this score, shifting scores
		...
		love.filesystem.write('breakoutSave.lst', scoresStr)
...
function EnterHighScoreState:render()
	...
	love.graphics.print(string.char(chars[1]), VIRTUAL_WIDTH / 2 - 28, VIRTUAL_HEIGHT / 3 + 20)
	love.graphics.setColor(1, 1, 1, 1)

	if highlightedChar == 2 then
		love.graphics.setColor(103/255, 1, 1, 1)
	end
	love.graphics.print(string.char(chars[2]), VIRTUAL_WIDTH / 2 - 6, VIRTUAL_HEIGHT / 3 + 20)
	love.graphics.setColor(1, 1, 1, 1)

	if highlightedChar == 3 then
		love.graphics.setColor(103/255, 1, 1, 1)
	end
	love.graphics.print(string.char(chars[3]), VIRTUAL_WIDTH / 2 + 16, VIRTUAL_HEIGHT / 3 + 20)
	love.graphics.setColor(1, 1, 1, 1)
